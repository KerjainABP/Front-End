        ...
        <div className='bg-[#E5E5E5] h-[90vh]  flex flex-col gap-6 border justify-center items-center '>
            <div className=''>
                ...
                <div className='flex flex-col bg-white lg:px-[72px] lg:py-8 lg:w-[450px]'>
                    <h1 className='mb-10 font-bold text-[36px]'>Masuk</h1>
                    <div className='mb-10'>
                        <p>Email</p>
                    ...
                    <div className="flex flex-col items-center"> 
                        ...
                        <button type="button" className="text-white w-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Masuk</button>
                        <p>Tidak punya akun? <Link to='/' className='text-[#003EC8]'>daftar disini</Link></p>
                    </div>
                </div>
